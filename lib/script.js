...
let gStoryline = document.querySelector('.gStoryline');
let gSummary = document.querySelector('.gSummary');
...
persona.addEventListener('click', evt =>{
  ...
  gName.innerHTML = games[0].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[0].storyline;
  gSummary.innerHTML = games[0].summary;
})

finalFantasy.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[1].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[1].storyline;
  gSummary.innerHTML = games[1].summary;
})

uncharted.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[2].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[2].storyline;
  gSummary.innerHTML = games[2].summary;
})

horizonZeroDawn.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[3].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[3].storyline;
  gSummary.innerHTML = games[3].summary;
})

shadowTombRaider.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[4].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[4].storyline;
  gSummary.innerHTML = games[4].summary;
})

watchDogs.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[5].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[5].storyline;
  gSummary.innerHTML = games[5].summary;
})

riseTombRaider.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[6].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[6].storyline;
  gSummary.innerHTML = games[6].summary;
})

bloodborne.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[7].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[7].storyline;
  gSummary.innerHTML = games[7].summary;
})

lifeStrange.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[8].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[8].storyline;
  gSummary.innerHTML = games[8].summary;
})

godWar.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[9].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[9].storyline;
  gSummary.innerHTML = games[9].summary;
})

lastOfUs.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[10].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[10].storyline;
  gSummary.innerHTML = games[10].summary;
})

spiderMan.addEventListener('click', evt =>{
  evt.preventDefault();
  modal.style.display = "block";
  gName.innerHTML = games[11].name; //not working says cannot set property of null
  gStoryline.innerHTML = games[11].storyline;
  gSummary.innerHTML = games[11].summary;
})
